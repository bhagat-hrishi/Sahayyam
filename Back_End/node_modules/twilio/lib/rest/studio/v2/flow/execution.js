...
ExecutionList = function ExecutionList(version, flowSid) {
   ...
   * @param {Date} [opts.dateCreatedFrom] - The date_created_from
   * @param {Date} [opts.dateCreatedTo] - The date_created_to
   ...
   * @param {object} [opts.parameters] - The parameters
 ...
 * @property {execution.status} status - The status
