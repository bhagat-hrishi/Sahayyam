 ...
 *
 * @constructor Twilio.Authy.V1.ServiceList
 *
...
ServiceList = function ServiceList(version) {
   ...
   *
   * @returns {Twilio.Authy.V1.ServiceContext}
   */
  /* jshint ignore:end */
   ...
   *
   * @function create
   * @memberof Twilio.Authy.V1.ServiceList#
   *
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Authy.V1.ServicePage
 *
 ...
 * @memberof Twilio.Authy.V1.ServicePage#
 *
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Authy.V1.ServiceInstance
 *
 ...
 *
 * @function remove
 * @memberof Twilio.Authy.V1.ServiceInstance#
 *
 * @param {object} [opts] - Options for request
 * @param {string} [opts.twilioAuthySandboxMode] -
 *          The Twilio-Authy-Sandbox-Mode HTTP request header
 ...
 */
/* jshint ignore:end */
ServiceInstance.prototype.remove = function remove(opts, callback) {
 ...
 */
/* jshint ignore:end */
ServiceInstance.prototype.fetch = function fetch(opts, callback) {
 ...
 * @memberof Twilio.Authy.V1.ServiceInstance#
 *
 * @returns {Twilio.Authy.V1.ServiceContext.EntityList}
 */
/* jshint ignore:end */
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Authy.V1.ServiceContext
 *
 * @property {Twilio.Authy.V1.ServiceContext.EntityList} entities -
 *          entities resource
 *
 * @param {V1} version - Version of the resource
 * @param {sid} sid - A string that uniquely identifies this Service.
 ...
 *
 * @function remove
 * @memberof Twilio.Authy.V1.ServiceContext#
 *
 * @param {object} [opts] - Options for request
 * @param {string} [opts.twilioAuthySandboxMode] -
 *          The Twilio-Authy-Sandbox-Mode HTTP request header
 ...
 */
/* jshint ignore:end */
ServiceContext.prototype.fetch = function fetch(opts, callback) {
  if (_.isFunction(opts)) {
    callback = opts;
    opts = {};
  }
